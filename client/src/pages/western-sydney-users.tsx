  ...
  const userRoles = [
    {
      ...
      description: "Manage inventory and coordinate shipments",
      features: [
        {
          id: 2,
          name: "Predictive Supply Chain Resilience",
          benefit: "Alerts to stock up or shift inventory before disruptions",
        },
        {
          id: 5,
          name: "Multi-Modal Logistics Orchestration",
          benefit: "Guidance on loading for road, drone, or air transport",
        },
        {
          id: 9,
          name: "Real-Time Client Dashboard",
          benefit: "Live shipment readiness status visualization",
        },
      ],
    ...
    },
    {
      ...
      description: "Oversee supply chain operations and optimize workflows",
      features: [
        {
          id: 1,
          name: "Hyper-Local Route Optimization",
          benefit: "Efficient routes planning for drivers and drones",
        },
        {
          id: 7,
          name: "Digital Twin for Scenario Planning",
          benefit: "Simulate what-if scenarios for better decisions",
        },
        {
          id: 3,
          name: "Sustainable AI-Driven Operations",
          benefit: "Track carbon impact and adjust operations",
        },
      ],
    ...
    },
    {
      ...
      description: "Deliver goods to clients manually or via autonomous vehicles",
      features: [
        {
          id: 1,
          name: "Hyper-Local Route Optimization",
          benefit: "Real-time, traffic-adjusted routes via in-vehicle systems",
        },
        {
          id: 8,
          name: "Autonomous Fleet Integration",
          benefit: "Coordination with autonomous vehicles, managing handoffs",
        },
        {
          id: 9,
          name: "Real-Time Client Dashboard",
          benefit: "Delivery status updates on the go",
        },
      ],
    ...
    },
    {
      id: "salespeople",
      title: "Salespeople",
      description: "Sell logistics services and pitch efficiency benefits",
      features: [
        {
          id: 6,
          name: "SME-Centric Customization",
          benefit: "Affordable, tailored options for SMEs to showcase",
        },
        {
          id: 9,
          name: "Real-Time Client Dashboard",
          benefit: "Demo of actionable insights for prospects",
        },
        {
          id: 3,
          name: "Sustainable AI-Driven Operations",
          benefit: "Eco-friendly selling points for conscious buyers",
        },
      ],
      workflow: "Use demo dashboards and case studies in sales meetings",
      icon: <Users className="h-5 w-5" />,
      ...
      features: [
        {
          ...
          benefit: "Ensure data security and protect business reputation",
        },
        {
          id: 10,
          name: "Partnerships and Ecosystem Integration",
          benefit: "Leverage grants and local ties for growth",
        },
        {
          id: 9,
          name: "Real-Time Client Dashboard",
          benefit: "Monitor overall performance via executive view",
        },
      ],
